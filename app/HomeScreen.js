...
const [userDetails, setUserDetails] = useState({});
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get('http://192.168.215.172:5000/categories');
  ...
  const fetchTasks = async () => {
    try {
      const response = await axios.get('http://192.168.215.172:5000/tasks', { params: { username } });
      //const response = await axios.get('http://192.168.215.172:5000/tasks');
  ...
  const fetchUserDetails = async () => {
    try {
      const response = await axios.get('http://192.168.215.172:5000/user-details', { params: { username } });
  ...
  const saveCategory = async () => {
    ...
    try {
      ...
      await axios.post('http://192.168.215.172:5000/categories', category);
  ...
  const handleCheckboxChange = async (taskId, isChecked) => {
    try {
      await axios.put(`http://192.168.215.172:5000/tasks/${taskId}`, { completed: isChecked });
